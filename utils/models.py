...
from utils.layers import GraphConvolution, GraphAttentionLayer, SpGraphAttentionLayer
DTYPE = torch.float32
...
if __name__ == '__main__':
    ...
    import os
    from ScalableGAE.scalable_graph_autoencoder import FromTemporalGraphToSparseAdj
    ...
    train_dataloader = NodeDataLoader(dgl_g,
                                      ...
                                      num_workers=0)
    device_id = 'cuda:0'
    model = ScalableGAE(in_dim=num_nodes * t, hid_dim=32, n_heads=4, out_dim=num_nodes).to(device_id)
